# 이 폴더는 비었다 — 펌웨어 문서는 `docs/06_firmware/` 에 있다

2026-08-27 문서 트리를 주제별 번호 체계(`docs/01_plan` … `docs/10_env_design`)로
재편하면서 펌웨어 문서도 [`docs/06_firmware/`](../../docs/06_firmware/) 로 옮겼다.
같은 문서가 두 군데 있으면 반드시 한쪽이 낡으므로 여기에는 사본을 두지 않는다.
